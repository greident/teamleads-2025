...
params:
  proof:
    lead: "Более 500 тимлидов, инженерных менеджеров и CTO из Kaspi, Kolesa, DAR, Chocofamily, InDrive и других компаний Казахстана."
    cadence: "Еженедельные встречи — разбор реальных кейсов, отчёты публикуем открыто."
    entries:
